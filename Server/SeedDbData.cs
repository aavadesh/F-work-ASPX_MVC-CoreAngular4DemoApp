...
namespace CoreAngular4DemoApp.Server
{
    public class SeedDbData
    {
        ...
        private void AddLanguagesAndContent()
        {
            ...
            if (!_context.ContentText.Any())
            {
                ...
                _context.ContentText.Add(new ContentText { Text = "Products", LanguageId = 1, ContentId = 3 });
                _context.ContentText.Add(new ContentText { Text = "Products", LanguageId = 2, ContentId = 3 });
